...
export class RecoverController {
  static readonly memoryCache = memoryStore({ ttl: 60000 }); //Verification code only valid for 60s
  constructor(
  ...
  async sendMail(@Query('toemail') toEmail): Promise<string> {
    const accountExists = await this.userRepo.findOne({
      where: { email: toEmail },
    });
    if (accountExists) {
      ...
      await this.mailService.sendMail({
        ...
        subject: `${accountExists.fullName} ơi! Bạn hãy đặt lại mật khẩu của mình nhé!🤍`,
        html: `<!DOCTYPE html>
        ...
        <head>
            ...
            <title>Xin chào! ${accountExists.fullName}! Cảm ơn bạn đã sử dụng sản phẩm của Khánh!</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
                      ...
                      <tr>
                        <td style="text-align: center;">
                          <div class="text-author">
                            <img src="https://images.pexels.com/photos/938580/pexels-photo-938580.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" style="width: 100px; max-width: 600px; height: auto; margin: auto; display: block;">
                            <h3 class="name">Khanh Nguyen</h3>
                            <span class="position">CEO, Founder at "Dong Hanh"</span>
                      <br>
                             <p class="btn btn-primary">${code}</p>
                             <p>Verification code only valid for 60s</p>
                           </div>
                        </td>
                      </tr>
                    </table>
                          ...
                          <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                              <td style="text-align: left; padding-right: 10px;">
                                ...
                                <p>A small river named Thu Bon flows by their place and supplies it with the necessary regelialia.</p>
                              </td>
                            </tr>
                          </table>
                        </td>
                          ...
                          <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                              <td style="text-align: left; padding-left: 5px; padding-right: 5px;">
                                ...
                                <ul>
                                  <li><span class="text">Dien Ban, Quang Nam, Viet Nam</span></li>
                                  <li><span class="text">+84 XX 1234 XXX</span></a></li>
                                </ul>
                              </td>
                            </tr>
                          </table>
